...
|------|-----------|--------|
| [`anthropic.mjs`](scripts/scrapers/anthropic.mjs) | Anthropic (Claude) | Работает |
| [`openai.mjs`](scripts/scrapers/openai.mjs) | OpenAI | Работает |
| [`google-gemini.mjs`](scripts/scrapers/google-gemini.mjs) | Google Gemini | Работает |
| [`deepseek.mjs`](scripts/scrapers/deepseek.mjs) | DeepSeek | Работает |
| [`aws-bedrock.mjs`](scripts/scrapers/aws-bedrock.mjs) | AWS Bedrock | Работает |
| [`mistral.mjs`](scripts/scrapers/mistral.mjs) | Mistral | SPA — откат на API |
| [`xai.mjs`](scripts/scrapers/xai.mjs) | xAI (Grok) | SPA — откат на API |
...
| `context_length` | Максимальный размер контекстного окна |
| `supports_vision` | Поддержка ввода изображений |
| `supports_function_calling` | Поддержка использования инструментов |
